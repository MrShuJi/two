...
public final class VideoBean: NSCoding {
  ...
  public required init(json: JSON) {
    ...
    data = VideoData(json: json[SerializationKeys.data])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? VideoData
